...
export interface IParameterCost extends IBaseDomainProperty {
  deviceId: string;
  year: number;
...
export class ParameterCost extends Entity<IParameterCost> {
  private constructor(props: IParameterCost) {
    const { id, ...data } = props;
    super(data, id);
  }

  public static create(props: IParameterCost): ParameterCost {
    return new ParameterCost(props);
  }

  public unmarshal(): IParameterCost {
    return {
      ...this.props,
      id: this._id,
    };
