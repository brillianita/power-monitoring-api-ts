import { IParameterCost } from "@/domain/models/power-monitoring/parameter-cost";
import { CreationOptional, DataTypes, InferAttributes, InferCreationAttributes, Model } from "sequelize";
import { Device } from "./device-sequelize";
import { sequelize } from "../../sequelize";

export class ParameterCost extends Model<InferAttributes<ParameterCost>, InferCreationAttributes<ParameterCost>> implements IParameterCost {
